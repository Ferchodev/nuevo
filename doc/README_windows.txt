...
After completing windows setup then run windows command line (cmd)
  cd daemon
  iaurabcoind
You would need to create a configuration file iaurabcoin.conf in the default
wallet directory. Grant access to iaurabcoind.exe in anti-virus and firewall
